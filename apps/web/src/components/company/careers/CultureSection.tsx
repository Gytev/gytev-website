  ...
  return (
    <section className="pt-0 pb-0">
      <div className="border-[rgba(255,255,255,0.08)] border-b">
        <div className="w-full relative h-auto flex flex-wrap lg:flex-nowrap border-[rgba(255,255,255,0.08)] lg:flex-row-reverse">
          {/* Text side (right on desktop) */}
          <div className="flex flex-col justify-end gap-6 w-full border-[rgba(255,255,255,0.08)] bg-[#111113] xl:w-[50%] px-4 md:px-10 lg:px-20 py-10 md:py-20 lg:py-30 border-l">
