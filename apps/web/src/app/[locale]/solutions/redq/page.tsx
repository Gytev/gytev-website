    ...
    <>
      <section className="border-b border-[rgba(255,255,255,0.08)] bg-[#0a0a0b]">
        <Container className="py-20">
          ...
          <p className="mt-6 max-w-2xl text-lg leading-8 text-[#999]">{solution.description}</p>
          <div className="mt-10">
            <a
      ...
      <section className="bg-[#0a0a0b]">
        <Container className="py-20">
          <div className="grid grid-cols-1 gap-6 sm:grid-cols-2">
            {pillars.map((pillar) => (
              <div key={pillar.title} className="rounded-2xl border border-[rgba(255,255,255,0.08)] p-8">
                <h2 className="text-lg font-semibold text-[#f0ede8]">{pillar.title}</h2>
                <p className="mt-3 text-sm leading-6 text-[#999]">{pillar.description}</p>
              </div>
            ))}
          </div>
        </Container>
