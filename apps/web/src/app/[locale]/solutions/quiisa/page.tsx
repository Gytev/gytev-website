    ...
    <>
      <section className="border-b border-[rgba(255,255,255,0.08)] bg-[#0a0a0b]">
        <Container className="py-20">
          ...
          <p className="mt-6 max-w-2xl text-lg leading-8 text-[#999]">{solution.quiisa.description}</p>
        ...
        <Container className="py-20">
          ...
          <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3">
            {quiisa.features.map((feature) => (
              <div key={feature.title} className="rounded-2xl border border-[rgba(255,255,255,0.08)] p-8">
                <h3 className="text-lg font-semibold text-[#f0ede8]">{feature.title}</h3>
                <p className="mt-3 text-sm leading-6 text-[#999]">{feature.description}</p>
              </div>
            ))}
          </div>
        </Container>
