      ...
      <div className="px-6 md:px-8 pt-24 md:pt-32 pb-20">
        <Container>
          <div className="max-w-3xl mx-auto">
            ...
            {terms.published_at && (
              <p className="mt-4 text-[13px] text-[#a0a0a0]">
            ...
            <div className="mt-16 space-y-16">
              ...
              {terms.intro_content && (
                <p className="text-[15px] leading-[1.7] mb-6 last:mb-0">
                  {terms.intro_content}
                </p>
              )}
                ...
                <section key={section.id} id={section.id} className="scroll-mt-24">
                  ...
                  <div
                    className="legal-content
                      [&_p]:text-[15px] [&_p]:leading-[1.7] [&_p]:mb-6 [&_p]:last:mb-0
                      ...
                      [&_.legal-address]:text-[15px] [&_.legal-address]:font-normal"
