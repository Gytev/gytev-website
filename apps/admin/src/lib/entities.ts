...
export const entities: EntityConfig[] = [
  ...
  },
  {
    ...
    endpoint: "/customers",
    titleField: "name",
    showFields: ["name", "sector", "country", "locale", "badge"],
    fields: [
      localeField,
      { name: "slug", label: "Slug", required: true },
      { name: "name", label: "Name", required: true },
      ...
      { name: "badge", label: "Badge", hint: "Ex: AGRICULTURE, PUBLIC HEALTH" },
      { name: "quote", label: "Quote", kind: "textarea" },
      { name: "quote_author", label: "Quote author" },
      { name: "quote_role", label: "Quote role" },
      { name: "image", label: "Hero image URL", hint: "Path or URL to the case study image" },
      { name: "video_url", label: "Video URL", hint: "YouTube or Vimeo URL" },
      { name: "overview", label: "Overview", kind: "textarea", hint: "Long description of the customer" },
      { name: "challenge", label: "Challenge", kind: "textarea", hint: "What problem did they face?" },
      { name: "solution", label: "Solution", kind: "textarea", hint: "How did Gytev help?" },
      { name: "results", label: "Results", kind: "textarea", hint: "What were the outcomes?" },
      { name: "metrics", label: "Metrics (JSON)", kind: "textarea", hint: 'JSON array: [{"label":"ROI","value":"+42%"}]' },
    ],
  },
  {
    slug: "milestones",
